...
plt.tight_layout()
plt.savefig(SCRIPT_DIR / 'fig1_mpl_mpk.png', dpi=150)
plt.close()
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig(SCRIPT_DIR / 'fig2_efficiency_scale.png', dpi=150)
plt.close()
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig(SCRIPT_DIR / 'fig3_isoquant.png', dpi=150)
plt.close()
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig(SCRIPT_DIR / 'fig4_isocline.png', dpi=150)
plt.close()
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig(SCRIPT_DIR / 'fig5_isoquant_isocline.png', dpi=150)
plt.close()
